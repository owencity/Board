				...
				<tr>
					...
					<td colspan="2">
						<div class="form-group" style="text-align: center; margin: 0 auto;">
							...
							<label class="btn btn-primary <c:if test="${memverVo.memGender eq '남자' }">active</c:if>">
								<input id="memGender" name="memGender" type="radio" autocomplete="off" value="남자" 
								<c:if test="${memverVo.memGender eq '남자' }">cheked</c:if>/>남자
							</label>
							<label class="btn btn-primary <c:if test="${memverVo.memGender eq '남자' }">active</c:if>">
								<input id="memGender" name="memGender" type="radio" autocomplete="off" value="여자"
								<c:if test="${memverVo.memGender eq '여자' }">cheked</c:if>/>여자
							</label>
							</div>
						</div>
					</td>
